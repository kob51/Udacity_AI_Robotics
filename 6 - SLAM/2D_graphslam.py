...
def slam(data, N, num_landmarks, motion_noise, measurement_noise):
    ...
    # N = length of path
    # multiplied by 2 becasue you need x and y for each point
    ...
    for k in range(len(data)):
        ...
        for i in range(len(measurement)):
            ...
            for b in range(2):
                # this routine is similar to what is done in 1D_graphslam.py
                # using noise instead of a confidence factor
